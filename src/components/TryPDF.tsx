...
const formatTime = (timeString: string): string => {
  ...
  const [time, period] = timeString.split(" "); // "10:28:35 PM" -> ["10:28:35", "PM"]
  const [hours, minutes] = time.split(":"); // "10:28:35" -> ["10", "28"]

  // Return the formatted time without the seconds
      ...
      <View style={styles.borderContainer}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.section}>
            <Text style={styles.headerText}>APALIT RURAL HEALTH UNIT III</Text>
            <Text style={styles.headerTextUnder1}>MUNICIPALITY OF APALIT</Text>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={styles.broughtCon}>
            ...
            <View>
              ...
              >
                {userData.broughtBy === "Police" ? "(/) POLICE" : "( ) POLICE"}
              </Text>
              <Text>
        ...
        <View style={{ height: 80, borderBottom: "2px solid black" }}>
          ...
          <Text style={styles.briefHistoryText}>
            ...
            venenatis enim. Suspendisse potenti. Integer ac bibendum elit. Cras
            et leo ut lorem ullamcorper fermentum sed vel lacus. Duis nec odio
            nisl. Suspendisse in neque ac orci venenatis pharetra. Sed eu dui
            quis velit pharetra vehicula non at est. Curabitur in justo sit amet
            magna dignissim tristique nec quis odio.
          </Text>
        </View>
        {/* seventhrow */}
        {/* eighthrow */}
