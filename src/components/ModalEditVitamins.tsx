      ...
      {showModalSuccess && (
        <div className="fixed inset-0 flex justify-end items-start z-50 p-4">
          ...
          >
            ...
            <span className="text-white">Vitamin Updated Successfully!</span>
          </div>
        </div>
      )}
      <div
                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3
                      ...
                      id="modal-headline"
                    >
                      Delete vitamin Image
                    </h3>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete this vitamin image?
                      </p>
                    </div>
                  </div>
                </div>
...
export default ModalEditVitamins;
