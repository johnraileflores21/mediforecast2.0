                                        ...
                                        <div className="flex flex-row">
                                            ...
                                            <div className="w-full">
                                                ...
                                                <input
                                                    ...
                                                    value={
                                                        vitamin.vitaminRegulatoryClassification
                                                    }
                                                    className="mt-1 block w-full p-2 border border-gray-300 rounded-md ml-1"
                                                    disabled
                                                />
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="relative mt-1">
                                                ...
                                                >
                                                    ...
                                                    <option value="Balucuc">
                                                        Balucuc
                                                    </option>
                                                    <option value="Calantipe">
                                                        Calantipe
                                                    </option>
                                                    <option value="Cansinala">
                                                        Cansinala
                                                    </option>
                                                    <option value="Capalangan">
                                                        Capalangan
                                                    </option>
                                                    <option value="Colgante">
                                                        Colgante
                                                    </option>
                                                    <option value="Paligui">
                                                        Paligui
                                                    </option>
                                                    ...
                                                    <option value="Sulipan">
                                                        Sulipan
                                                    </option>
                                                    <option value="Tabuyuc">
                                                        Tabuyuc
                                                    </option>
                                                </select>
                                                <svg
