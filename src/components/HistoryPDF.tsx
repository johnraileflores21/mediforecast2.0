...
import { formatDate } from '../assets/common/constants';
...
const HistoryPDF = ({ data, user, header }: any) => {
            ...
            <View style={styles.tableRow} key={index}>
              {hasBarangay && (
                <View style={[styles.tableCol, { width: columnWidths.barangay }]}>
                  <Text style={styles.tableCell}>{itemData.fullName}</Text>
                </View>
              )}
              ...
              <View style={[styles.tableCol, { width: columnWidths.quantity }]}>
                <Text style={styles.tableCell}>{itemData.itemName}</Text>
              </View>
              <View style={[styles.tableCol, { width: columnWidths.status }]}>
                <Text style={styles.tableCell}>{itemData.quantity || "N/A"}</Text>
              </View>
              <View style={[styles.tableColLeft, { width: columnWidths.reason }]}>
                <Text style={styles.tableCell}>{formatDate(itemData.timestamp)}</Text>
              </View>
            </View>
          ))}
        </View>
