...
import ModalPost from "../../components/Post";
...
const CommunityBin = () => {
  ...
  const brgyImg = () => {
    return brgyLogos[user?.barangay];
  }
      ...
      <div className="space-x-8">
        <div className="w-full">
          <div className="bg-white w-full mt-4 rounded-lg shadow-md p-4 flex items-center">
            <img
              src={!user?.role.includes('Barangay')
                ? userImg(user?.rhuOrBarangay)
                : brgyImg()
              }
              alt="Profile"
